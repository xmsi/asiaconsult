	...
	<div class="card-body">
		...
		<form action="{{ route('speciality.update', $speciality->id) }}" method="post" accept-charset="utf-8" enctype="multipart/form-data">
			...
			<div class="form-group">
				...
				<input type="number" name="volume" value="{{ $speciality->volume }}" class="form-control">
			</div>
			<br>
			<div class="form-check">
				<input type="checkbox" name="dogovor_free" class="form-check-input" id="exampleCheck11" value="1" @if($speciality->dogovor_free) checked @endif>
