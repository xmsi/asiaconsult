...
@section('content')
			<section class="modal popup container-fluid">
				<div class="content col-xl-6 col-lg-8 col-md-10 col-sm-12 col-12">
					<h2>@lang('Ваши документы переданы на обработку')</h2>
					<p>
						@lang('Если обработка пройдет успешно, в ваш личный кабинет будет отправлено подтверждение о зачислении Вас в ряды
					...
					<p class="title">@lang('Обработка документов займет около 3 - х дней')</p>
				</div>
